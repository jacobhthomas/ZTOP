...
c  separately.
c
c 2024 addition to store multiple PDF set results in parallel.
c      
      implicit double precision (a-h,o-z)
      character * 40 pref,fname,lpref, centralTable
      character * 2 tend
      integer i,j,it1,it2
      ...
      double precision avgin(100), sdn(100)
      common/pdfresults/avgin, sdn
      double precision tsumn(100), tdsumn(100), lo2n(100), slo2n(100)
      double precision nlo2n(100), snlo2n(100), nlo3n(100), snlo3n(100)
...
cz Modify to load multiple sets here
...
c     call SetCT18(Tablefile)
      centralTable = "CT18NLO-pds/i2Tn2."
      call SetCT18Multi(centralTable)
...
c. lo
 ...
 102     format(1x,e14.6,e11.4)
         ...
         write (11,*) "Error PDFs"
         do iwrt=1,59
            tsumn(iwrt) = avgin(iwrt)
            tdsumn(iwrt) = sdn(iwrt)
            write(*,102) tsumn(iwrt), tdsumn(iwrt)
            write(11,102) tsumn(iwrt), tdsumn(iwrt)
         enddo
         call whist
         goto 1001
...
c. nlo
         ...
         do iwrt=1,59
            nlo2n(iwrt) = avgin(iwrt)
            snlo2n(iwrt) = sdn(iwrt)
         enddo
         call vsup(7,npt3,its3,tnlo3,aitnlo3,sdtnlo3,chi2tnlo2)
         do iwrt=1,59
            nlo3n(iwrt) = avgin(iwrt)
            snlo3n(iwrt) = sdn(iwrt)
            tsumn(iwrt) = nlo2n(iwrt) + nlo3n(iwrt)
            tdsumn(iwrt) = dsqrt(snlo2n(iwrt)**2 + snlo3n(iwrt)**2)
         enddo
     ...
     &deltas,deltac,aitnlo2,sdtnlo2,aitnlo3,sdtnlo3,tsum,tdsum
         ...
         do iwrt=1,59
            write(*,101) 
     &      deltas,deltac,nlo2n(iwrt),snlo2n(iwrt),nlo3n(iwrt),snlo3n(iwrt),
     &      tsumn(iwrt),tdsumn(iwrt)
            write(11,101) 
     &      deltas,deltac,nlo2n(iwrt),snlo2n(iwrt),nlo3n(iwrt),snlo3n(iwrt),
     &      tsumn(iwrt),tdsumn(iwrt)
         enddo
...
c. lo+nlo
         ...
         do iwrt=1,59
            nlo3n(iwrt) = avgin(iwrt)
            snlo3n(iwrt) = sdn(iwrt)
            tsumn(iwrt) = lo2n(iwrt) + nlo2n(iwrt) + nlo3n(iwrt)
            tdsumn(iwrt) = dsqrt(slo2n(iwrt)**2 + snlo2n(iwrt)**2 +
     &           snlo3n(iwrt)**2)
         enddo
     ...
     &        tsum,tdsum
c         write(11,103)
c     &deltas,deltac,aitlo2,sdtlo2,aitnlo2,sdtnlo2,aitnlo3,sdtnlo3,
c     &        tsum,tdsum
         
         write (*,*) "Error PDFs"
c         write (11,*) "Error PDFs"
         do iwrt=1,59
            write(*,103) 
     &      deltas,deltac,lo2n(iwrt),slo2n(iwrt),nlo2n(iwrt),
     &      snlo2n(iwrt),nlo3n(iwrt),snlo3n(iwrt),tsumn(iwrt),
     &      tdsumn(iwrt)
            write(11,103) 
     &      deltas,deltac,lo2n(iwrt),slo2n(iwrt),nlo2n(iwrt),
     &      snlo2n(iwrt),nlo3n(iwrt),snlo3n(iwrt),tsumn(iwrt),
