...
C
      ...
      double precision xpdf1(-6:xpdfmax), xpdf2(-6:xpdfmax),
     &     xpdfb1(-6:xpdfmax), xpdfb2(-6:xpdfmax)
...
c
      ...
      CALL PFTOPDGN(xa,SCALE1,xpdf1)
      CALL PFTOPDGN(xb,SCALEB1,xpdfb1)
      CALL PFTOPDGN(xb,SCALE2,xpdf2)
      CALL PFTOPDGN(xa,SCALEB2,xpdfb2)
...
c Get PDFs
c
c      CALL PFTOPDG(xa,SCALE1,XPQ1)
c      CALL PFTOPDG(xb,SCALEB1,XPQB1)
c      CALL PFTOPDG(xb,SCALE2,XPQ2)
c     CALL PFTOPDG(xa,SCALEB2,XPQB2)
c      DO I=-6,6
c         XPQ1(i)=XPQ1(i)/xa
c         XPQB1(i)=XPQB1(i)/xb
c         XPQ2(i)=XPQ2(i)/xb
c         XPQB2(i)=XPQB2(i)/xa
c      ENDDO
      DO I=-6,6
         XPQ1(i)=xpdf1(i + 13*iloop)/xa
         XPQB1(i)=xpdfb1(i + 13*iloop)/xb
         XPQ2(i)=xpdf2(i + 13*iloop)/xb
         XPQB2(i)=xpdfb2(i + 13*iloop)/xa
      ENDDO
